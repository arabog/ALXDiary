...
Q: Use a nested for loop to take the numbers array below 
and replace all of the values that are divisible by 2 (even 
numbers) with the string "even" and all other numbers 
with the string "odd".
...
for (row = 0; row < numbers.length; row++) {
          for (c = 0; c < numbers[row].length; c++){
                    if(numbers[row][c] % 2 === 0) {
                              numbers[row][c] = "even";
                    }else  if(numbers[row][c] % 3 === 0) {
                              numbers[row][c] = "odd";
                    }

                    console.log(numbers[row][c]) 
          }          
}
